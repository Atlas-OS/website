...
If you're on an [outdated Atlas version](https://github.com/Atlas-OS/Atlas/releases), we can't help. If you have issues on the latest version, try these first:
...
We're improving Atlas. Consider reporting your problem on [Atlas GitHub Issues](https://github.com/Atlas-OS/Atlas/issues) so we can fix it. You can also give feedback in GitHub Discussions or Discord.
