...
If you are on an [outdated Atlas version](https://github.com/Atlas-OS/Atlas/releases), we cannot help. If you have issues on the latest version, try these first:

- The documentation you're on currently
- [Our Discord server](https://discord.com/invite/atlasos)
- [Atlas GitHub Discussions](https://github.com/Atlas-OS/Atlas/discussions)

### Still having problems?

We are improving Atlas. Consider reporting your problem on [Atlas GitHub Issues](https://github.com/Atlas-OS/Atlas/issues) so we can fix it. You can also give feedback in GitHub Discussions or Discord.
