...
- Verify you're on AtlasOS 0.4.1 or newer (Windows 11 24H2 or 25H2)
...
You likely have not followed the installation documentation to reinstall Windows. Atlas requires a full Windows reinstall. Do not use "Reset this PC". Follow the [Installation Guide](/docs/install/requirements/).
...
1. Ensure you're on a fresh, fully updated Windows install (follow the [Installation Guide](/docs/install/requirements/))
