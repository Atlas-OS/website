...
- Confirm you're on a version supported by the Playbook you are applying. The current Playbook declares AtlasOS v0.5.0 as its direct upgrade source.
...
5. Click **Show logs**, open **Output.txt**, and identify the stalled process. End it in Task Manager, then apply the Playbook again
